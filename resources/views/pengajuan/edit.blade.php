...
@section('content')
    ...
    <div class="row col-md-5 mx-auto p-3 mb-4">
        <div class="card shadow" style="border-radius: .5rem;">
            <div class="card-body pt-4 pb-4">
                ...
                @endif
                <form class="row g-3" action="{{ route('edit') }}" method="POST">
                    @csrf
                    <input type="text" class="form-control" id="id" name="id" hidden value="{{ $data_edit->id }}">
                    <div class="col-md-12">
                        <label for="kode_pengajuan" class="form-label">Kode Pengajuan</label>
                        <input type="text" class="form-control" id="kode_pengajuan" name="kode_pengajuan" disabled
                            value="{{ $data_edit->kode_pengajuan }}">
                    </div>
                    ...
                    <div x-data="{ open: true }">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="tgl_mulai" name="tgl_mulai" value="">
                            </div>
                            <div class="col-md-6" x-show="open">
                                <label for="tgl_selesai" class="form-label">Tanggal Selesai</label>
                                <input type="text" class="form-control" id="tgl_selesai" name="tgl_selesai" value="">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="keterangan" rows="3" name="keterangan"
                            @if ($data_edit->status == 3) disabled @endif>{{ $data_edit->keterangan }}</textarea>
                    </div>
                    <div class="col-md-12 text-center mt-4">
                        <button type="submit" class="btn btn-dark" @if ($data_edit->status == 3) disabled @endif>Edit
                            Pengajuan Cuti</button>
