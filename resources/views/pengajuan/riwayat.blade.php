    ...
    <div class="main">
        ...
        <div class="container mx-auto">
            ...
            <div class="shadow p-4 mx-auto">
                ...
                <h2 class="text-center mb-5">Riwayat Pengajuan Cuti</h2>
                @if (session('status'))
                    ...
                    <tbody>
                        ...
                        @foreach ($data_pengajuan as $data)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm bg-primary" href="{{ $data->id }}/detail"><img
                                            fill="currentColor" src="{{ asset('img/eye.svg') }}" alt=""></a>
                                    <a class="btn btn-sm bg-warning" href="{{ $data->id }}/update"><img
